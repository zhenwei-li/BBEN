package com.bben.webservice.config;

import com.bben.common.exception.ErrorType;
        ...
        public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
            ...
            */
            ...
            if (U.isBlank(sessionToken) || U.isBlank(sessionTokenKey)) {
                ...
                mapError.put("code", ErrorType.no_login.getCode());
                mapError.put("message", ErrorType.no_login.getMsg());
                mapError.put("data", "");
