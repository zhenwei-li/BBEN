...
public class THospital implements Serializable {
    ...
    public void setMasterMobile(String masterMobile) {
        this.masterMobile = masterMobile == null ? null : masterMobile.trim();
    }
    ...
    public Boolean getIsShowWeb() {
        return isShowWeb;
    }

    public void setIsShowWeb(Boolean isShowWeb) {
    ...
    public String toString() {
        ...
        sb.append(", masterMobile=").append(masterMobile);
