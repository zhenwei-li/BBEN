...
public class TMedicationRecord implements Serializable {
    private Integer id;
    ...
    public Integer getDrugDeliveryNurseId() {
        return drugDeliveryNurseId;
    }

    public void setDrugDeliveryNurseId(Integer drugDeliveryNurseId) {
    ...
    public void setDateOfHospitalization(Date dateOfHospitalization) {
    ...
    public String toString() {
        ...
        sb.append(", drugDeliveryNurseId=").append(drugDeliveryNurseId);
        sb.append(", dateOfHospitalization=").append(dateOfHospitalization);
